...
export const metadata: Metadata = { title: "免責聲明", description: "毛孩旅宿指南寵物旅館資料與外部連結免責說明。", alternates: { canonical: "/disclaimer" }, openGraph: { title: "免責聲明", description: "旅館資料更新與外部連結說明。" } };
